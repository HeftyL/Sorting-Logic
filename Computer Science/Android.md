...
- ![Android 软件堆栈](assets/android-stack_2x.png)
...
- ==问题==：view和子类的继承关系是什么样的？
  - ![View继承关系](D:\Sorting-Logic\Computer Science\assets\SouthEast.jpeg)
...
- ![image-20220616110542625](D:\Sorting-Logic\Computer_Science\assets\image-20220616110542625.png)
  - 常用的实现类
...
- ![image-20220617133426871](assets\image-20220617133426871.png)
...
- ![image-20220617165657046](assets\image-20220617165657046.png)
...
- 系统中的活动作为 活动堆栈进行管理。当一个新的activity启动时，它通常被放置在当前栈的顶部，成为正在运行的activity——前一个activity在栈中始终保持在它的下方，并且在新的activity退出之前不会再次来到前台。屏幕上可以看到一个或多个活动堆栈。
  ...
  - ![image-20220620094827377](assets\image-20220620094827377.png)
...
- ![image-20220620105526905](assets/image-20220620105526905.png)
...
- ![image-20220622150030955](assets/image-20220622150030955.png)
...
- ![image-20220623093215507](assets/image-20220623093215507.png)
