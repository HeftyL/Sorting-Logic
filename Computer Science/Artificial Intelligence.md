...
- 一、预训练
  - [1.1 图像领域的预训练](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-6m3Eji)
  - [1.2 预训练的思想](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-WcwtJS)
- 二、语言模型
  - [2.1 统计语言模型](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-MMi3E2)
  - [2.2 神经网络语言模型](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-FQPyTC)
- 三、词向量
  - [3.1 独热（Onehot）编码](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-77sABW)
  - [3.2 Word Embedding](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-D87PH7)
- [四、Word2Vec 模型](https://www.cnblogs.com/nickchen121/p/16470569.html#四word2vec-模型)
- [五、自然语言处理的预训练模型](https://www.cnblogs.com/nickchen121/p/16470569.html#五自然语言处理的预训练模型)
- 六、RNN 和 LSTM
  - [6.1 RNN](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-tszKxz)
  - [6.2 RNN 的梯度消失问题](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-eYdG2P)
  - [6.3 LSTM](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-ndmGR8)
  - [6.4 LSTM 解决 RNN 的梯度消失问题](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-2dhmed)
- 七、ELMo 模型
  - [7.1 ELMo 的预训练](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-C2YnnH)
  - [7.2 ELMo 的 Feature-based Pre-Training](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-dpsJaM)
- 八、Attention
  - [8.1 人类的视觉注意力](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-bn4Rdn)
  - [8.2 Attention 的本质思想](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-S3t38M)
  - [8.3 Self Attention 模型](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-4ZtrWf)
  - [8.4 Self Attention 和 RNN、LSTM 的区别](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-MMb6za)
  - [8.5 Masked Self Attention 模型](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-AFXGXG)
  - [8.6 Multi-head Self Attention 模型](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-ezPmyy)
- [九、Position Embedding](https://www.cnblogs.com/nickchen121/p/16470569.html#九position-embedding)
- 十、Transformer
  - [10.1 Transformer 的结构](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-wQc8KA)
  - [10.2 Encoder](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-TZrG8Y)
  - [10.3 Decoder](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-Yf6a7P)
  - [10.4 Transformer 输出结果](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-CprrZJ)
- 十一、Transformer 动态流程展示
  - [11.1 为什么 Decoder 需要做 Mask](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-TDmWnM)
  - [11.2 为什么 Encoder 给予 Decoders 的是 K、V 矩阵](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-MZmtHE)
- 十二、GPT 模型
  - [12.1 GPT 模型的预训练](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-N8rnhJ)
  - [12.2 GPT 模型的 Fine-tuning](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-ApzszZ)
- 十三、BERT 模型
  - [13.1 BERT：公认的里程碑](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-4kwXbf)
  - [13.2 BERT 的结构：强大的特征提取能力](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-GWBC5T)
  - [13.3 BERT 之无监督训练](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-Tb7WG2)
  - [13.4 BERT之语言掩码模型（MLM）](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-bTwTby)
  - [13.5 BERT 之下句预测（NSP）](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-ZtsZ8M)
  - [13.6 BERT 之输入表示](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-pCa7fd)
- 十四、BERT 下游任务改造
  - [14.1 句对分类](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-rt2AdB)
  - [14.2 单句分类](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-wn7yJ3)
  - [14.3 文本问答](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-Qe6f7n)
  - [14.4 单句标注](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-pd8awZ)
  - [14.5 BERT效果展示](https://www.cnblogs.com/nickchen121/p/16470569.html#tid-TSrEbZ)
- [十五、预训练语言模型总结](https://www.cnblogs.com/nickchen121/p/16470569.html#十五预训练语言模型总结)
- [十六、参考资料](https://www.cnblogs.com/nickchen121/p/16470569.html#十六参考资料)
...
[![img](assets/图像预训练示例.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/图像预训练示例.jpg)
...
[![img](assets/预训练的应用.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/预训练的应用.jpg)
...
[![img](assets/预训练在图像领域的应用.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/预训练在图像领域的应用.jpg)
...
语言模型通俗点讲就是**计算一个句子的概率。**也就是说，对于语言序列 w1,w2,⋯,wn，语言模型就是计算该序列的概率，即 P(w1,w2,⋯,wn)。
...
P(w1,w2,⋯,wn)=P(w1)P(w2|w1)P(w3|w1,w2)⋯p(wn|w1,w2,⋯,wn−1)=∏iP(wi|w1,w2,⋯,wi−1)
...
P(判断，这个，词，的，词性)=P(判断)P(这个|判断)P(词|判断，这个)P(的|判断，这个，词)P(词性|判断，这个，词，的)P(判断，这个，词，的，词性)
...
P(wnext|判断，这个，词，的)=count(wnext，判断，这个，词，的)count(判断，这个，词，的)公式(2)
...
P(wnext|判断，这个，词，的)≈P(wnext|词，的)公式(3)



公式（3）就是马尔科夫链的思想：假设 wnext 只和它之前的 **k 个词有相关性**，k=1 时称作一个单元语言模型，k=2 时称为二元语言模型。
...
P(wi|wi−1)=count(wi−1,wi)count(wi−1)公式(4)
...
P(词性|的)=count(的，词性)count(的)=23公式(5)
...
[![img](assets/神经网络语言模型.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/神经网络语言模型.jpg)

上图为神经网络语言模型结构图，它的学习任务是输入某个句中单词 wt=bert 前的 t−1 个单词，要求网络正确预测单词 “bert”，即最大化：



P(wt=bert|w1,w2,⋯,wt−1;θ)公式(7)



上图所示的神经网络语言模型分为三层，接下来我们详细讲解这三层的作用：

1. 神经网络语言模型的第一层，为输入层。首先将前 n−1 个单词用 Onehot 编码（例如：0001000）作为原始单词输入，之后乘以一个随机初始化的矩阵 Q 后获得词向量 C(wi)，对这 n−1 个词向量处理后得到输入 x，记作 x=(C(w1),C(w2),⋯,C(wt−1))
2. 神经网络语言模型的第二层，为隐层，包含 h 个隐变量，H 代表权重矩阵，因此隐层的输出为 Hx+d，其中 d 为偏置项。并且在此之后使用 tanh 作为激活函数。
3. 神经网络语言模型的第三层，为输出层，一共有 |V| 个输出节点（字典大小），直观上讲，每个输出节点 yi 是词典中每一个单词概率值。最终得到的计算公式为：y=softmax(b+Wx+Utanh(d+Hx))，其中 W 是直接从输入层到输出层的权重矩阵，U 是隐层到输出层的参数矩阵。

# 三、词向量

在描述神经网络语言模型的时候，提到 Onehot 编码和词向量 C(wi)，但是并没有具体提及他们到底是什么玩意。
...
[![img](assets/单词的独热表示.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/单词的独热表示.jpg)
...
[00010]⎡⎢ ⎢ ⎢ ⎢ ⎢ ⎢⎣1724123574613101219111825⎤⎥ ⎥ ⎥ ⎥ ⎥ ⎥⎦=[101219]公式(8)
...
[![img](assets/wordembedding例子.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/wordembedding例子.jpg)
...
[![img](assets/word2vec.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/word2vec.jpg)
...
[![img](assets/we模式下的预训练.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/we模式下的预训练.jpg)
...
[![img](assets/RNN-unrolled.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/RNN-unrolled.png)
...
[![img](assets/RNN模型结构.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/RNN模型结构.jpg)

如上图所示，为RNN模型结构，前向传播过程包括：

- **隐藏状态：**h(t)=σ(z(t))=σ(Ux(t)+Wh(t−1)+b) ，此处激活函数一般为 tanh 。
- **模型输出：**o(t)=Vh(t)+c
- **预测输出：**^y(t)=σ(o(t)) ，此处激活函数一般为softmax。
- **模型损失：**L=∑Tt=1L(t)
...
∂L∂W=T∑t=1∂L∂y(T)∂y(T)∂o(T)∂o(T)∂h(T)(T∏k=t+1∂h(k)∂h(k−1))∂h(t)∂W =T∑t=1∂L∂y(T)∂y(T)∂o(T)∂o(T)∂h(T)(T∏k=t+1tanh′(z(k))W)∂h(t)∂W 公式(9)



对于公式（9）中的 (∏Tk=t+1∂h(k)∂h(k−1))=(∏Tk=t+1tanh′(z(k))W)，tanh 的导数总是小于 1 的，由于是 T−(t+1) 个 timestep 参数的连乘，**如果 W 的主特征值小于 1，梯度便会消失；如果 W 的特征值大于 1，梯度便会爆炸。**

需要注意的是，RNN和DNN梯度消失和梯度爆炸含义并不相同。

RNN中权重在各时间步内共享，最终的梯度是各个时间步的梯度和，梯度和会越来越大。因此，RNN中总的梯度是不会消失的，即使梯度越传越弱，也只是远距离的梯度消失。 从公式（9）中的 (∏Tk=t+1tanh′(z(k))W) 可以看到，**RNN所谓梯度消失的真正含义是，梯度被近距离（t+1趋向于T）梯度主导，远距离（t+1远离T）梯度很小，导致模型难以学到远距离的信息。**

## 6.3 LSTM

为了解决 RNN 缺乏的序列长距离依赖问题，LSTM 被提了出来，首先我们来看看 LSTM 相对于 RNN 做了哪些改进：

[![img](assets/LSTM模型结构.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/LSTM模型结构.jpg)
...
- 遗忘门：
  ...
  ，经过 Sigmoid 函数后输出一个 0 到 1 之间的值

   

  ft

  - 输出： ft=σ(Wfht−1+Ufxt+bf)

- 输入门：

  决定了哪些新信息被保留，并更新细胞状态，输入们的取值由
  ...
  决定，通过 Sigmoid 函数得到一个 0 到 1 之间的值
  ...
  - 输出：it=σ(Wiht−1+Uixt+bi) , ~Ct=tanhWaht−1+Uaxt+ba
...
- 输出门：
  ...
  - 输出：ot=σ(Woht−1+Uoxt+bo) , ht=ot⊙tanhCt
...
RNN 梯度消失的原因是，随着梯度的传导，梯度被近距离梯度主导，模型难以学习到远距离的信息。具体原因也就是 ∏Tk=t+1∂hk∂hk−1 部分，在迭代过程中，每一步 ∂hk∂hk−1 **始终在 [0,1) 之间或者始终大于 1。**

而对于 LSTM 模型而言，针对 ∏Tk=t+1∂Ck∂Ck−1 求得：



∂Ck∂Ck−1=fk+otherT∏k=t+1∂Ck∂Ck−1=fkfk+1...fT+other(1)(2)



在 LSTM 迭代过程中，针对 ∏Tk=t+1∂Ck∂Ck−1 而言，每一步∂Ck∂Ck−1 **可以自主的选择在 [0,1] 之间，或者大于1**，因为 fk 是可训练学习的。那么整体 ∏Tk=t+1∂Ck∂Ck−1 也就不会一直减小，远距离梯度不至于完全消失，也就能够解决 RNN 中存在的梯度消失问题。

LSTM 遗忘门值 ft 可以选择在 [0,1] 之间，让 LSTM 来改善梯度消失的情况。也可以选择接近 1，让遗忘门饱和，此时远距离信息梯度不消失；也可以选择接近 0，此时模型是故意阻断梯度流，遗忘之前信息。
...
[![img](assets/we多义词问题.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/we多义词问题.jpg)
...
[![img](assets/基于上下文的emedding.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/基于上下文的emedding.jpg)
...
[![img](assets/elmo训练后的使用.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/elmo训练后的使用.jpg)
...
[![img](assets/人类的视觉注意力.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/人类的视觉注意力.jpg)
...
[![img](assets/attention-计算图.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/attention-计算图.png)
...
1. 第一步：计算比较 Q 和 K 的相似度，用 f 来表示：

   f(Q,Ki)i=1,2,⋯,m

   ，一般第一步计算方法包括四种

   1. 点乘（**Transformer 使用**）：f(Q,Ki)=QTKi
   2. 权重：f(Q,Ki)=QTWKi
   3. 拼接权重：f(Q,Ki)=W[QT;Ki]
   4. 感知器：f(Q,Ki)=VTtanh(WQ+UKi)

2. 第二步：将得到的相似度进行 softmax 操作，进行归一化：

   αi=softmax(f(Q,Ki)√dk)

   1. 这里简单讲解除以 √dk 的作用：假设 Q , K 里的元素的均值为0，方差为 1，那么 AT=QTK 中元素的均值为 0，方差为 d。当 d 变得很大时， A 中的元素的方差也会变得很大，如果 A 中的元素方差很大(分布的方差大，分布集中在绝对值大的区域)，**在数量级较大时， softmax 将几乎全部的概率分布都分配给了最大值对应的标签**，由于某一维度的数量级较大，进而会导致 softmax 未来求梯度时会消失。总结一下就是 softmax(A) 的分布会和d有关。因此 A 中每一个元素乘上 1√dk 后，方差又变为 1，并且 A 的数量级也将会变小。

3. 第三步：针对计算出来的权重 αi，对 V 中的所有 values 进行加权求和计算，得到 Attention 向量：Attention=∑mi=1αiVi
...
[![img](assets/self-attention.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/self-attention.jpg)
...
2. 第二步，MatMul
   ...
   1. ![img](assets/Q-K乘积.jpg)

      上图操作：向量 q1,k1 做点乘得到得分 112， q1,k2 做点乘得到得分96。注意：**这里是通过 q1 这个信息找到 x1,x2 中的重要信息。**

3. 第三步和第四步，Scale + Softmax

   1. [![img](assets/qk-scale.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/qk-scale.jpg)

   上图操作：对该得分进行规范，除以 √dk=8

4. 第五步，MatMul

   1. [![img](assets/qk-softmax.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/qk-softmax.jpg)
...
[![img](assets/QKV-矩阵表示.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/QKV-矩阵表示.jpg)

Q 对 K 转制做点乘，除以 √dk，做一个 softmax 得到合为 1 的比例，对 V 做点乘得到输出 Z。那么这个 Z 就是一个考虑过 Thinking 周围单词 Machine 的输出。

[![img](assets/QKVZ-结果.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/QKVZ-结果.jpg)
...
[![img](assets/注意力机制矩阵图.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/注意力机制矩阵图.jpg)
...
[![img](assets/self-attention-好处1.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/self-attention-好处1.jpg) [![img](assets/self-attention-好处2.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/self-attention-好处2.jpg)
...
[![img](assets/masked-attention.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/masked-attention.jpg)
...
[![img](assets/mask-attention-map.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/mask-attention-map.jpg)
...
[![img](assets/mask-attention-map-softmax.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/mask-attention-map-softmax.jpg)
...
[![img](assets/multi-head-attention.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/multi-head-attention.png)

我们还是以上面的形式来解释，我们对 Z 进行 8 等份的切分得到 8 个 Zi 矩阵：

[![img](assets/8-head-attention.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/8-head-attention.jpg)

为了使得输出与输入结构相同，拼接矩阵 Zi 后乘以一个线性 W0 得到最终的Z：

[![img](assets/8-z-拼接.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/8-z-拼接.jpg)

可以通过下图看看 multi-head attention 的整个流程：

[![img](assets/multi-head-拼接.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/multi-head-拼接.jpg)
...
[![img](assets/位置向量.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/位置向量.jpg)
...
[![img](assets/位置编码公式.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/位置编码公式.png)
...
[![img](assets/位置编码和词向量之和.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/位置编码和词向量之和.png)
...
[![img](assets/位置嵌入解释.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/位置嵌入解释.png)
...
[![img](assets/tf-整体框架.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-整体框架.jpg)

上图所示的整体框架乍一眼一看非常复杂，由于 Transformer 起初是作为翻译模型，因此我们以翻译举例，简化一下上述的整体框架：

[![img](assets/tf-框架简化.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-框架简化.jpg)
...
[![img](assets/tf-ed-框架.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-ed-框架.jpg)
...
[![img](assets/tf-ed-复杂.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-ed-复杂.jpg)

也就是说，Encoders 的输出，会和**每一层的 Decoder 进行结合**。

现在我们取其中一层进行详细的展示：

[![img](assets/ed-细分.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/ed-细分.jpg)
...
[![img](assets/encoder-详细图.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/encoder-详细图.png)
...
4. z1
   ...
   经过前馈神经网络（Feed Forward）层，经过残差结构与自身相加，之后经过 LN 层，得到一个输出向量
   ...
   1. 该前馈神经网络包括两个线性变换和一个ReLU激活函数：FFN(x)=max(0,xW1+b1)W2+b2
...
[![img](assets/ed-交互.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/ed-交互.jpg)
...
[![img](assets/tf-最后输出.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-最后输出.jpg)

假设词汇表维度是 6，那么输出最大概率词汇的过程如下：

[![img](assets/tf-最终输出结果.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-最终输出结果.jpg)

# 十一、Transformer 动态流程展示

首先我们来看看拿 Transformer 作翻译时，如何生成翻译结果的：

[![img](assets/tf-动态生成.gif)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-动态生成.gif)

继续进行：

[![img](assets/tf-动态结果-2.gif)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-动态结果-2.gif) [![img](assets/tf-整体框架.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/tf-整体框架.jpg)
...
3. 输入 “I am a student” 到 Decoders ，首先通过 Masked Multi-head Attention 层得到 “I am a student” 的 attention 值 Qd，然后用 attention 值 Qd 和 Encoders 的输出 Ke、Ve 矩阵进行 attention 计算，得到第 2 个输出 “am”；
4. ……
...
现在 Encoder 提供了 Ke、Ve 矩阵，Decoder 提供了 Qd 矩阵，通过 “我爱中国” 翻译为 “I love China” 这句话详细解释下。

当我们翻译 “I” 的时候，由于 Decoder 提供了 Qd 矩阵，通过与 Ke、Ve 矩阵的计算，它可以在 “我爱中国” 这四个字中找到对 “I” 翻译最有用的单词是哪几个，并以此为依据翻译出 “I” 这个单词，这就很好的体现了注意力机制想要达到的目的，把焦点放在对自己而言更为重要的信息上。
...
[![img](assets/gpt-模型.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/gpt-模型.jpg)
...
2. 其次，
   1. GPT 的预训练虽然仍然是以语言模型作为目标任务，但是采用的是单向的语言模型，所谓 “单向” 的含义是指：语言模型训练的任务目标是根据 wi 单词的上下文去正确预测单词 wi ， wi 之前的单词序列Context-before称为上文，之后的单词序列Context-after称为下文。
   2. ELMo 在做语言模型预训练的时候，预测单词 wi 同时使用了上文和下文，而 GPT 则只采用 Context-before 这个单词的上文来进行预测，而抛开了下文。
...
[![img](assets/gpt-fine.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/gpt-fine.jpg)
...
- 如下图所示，我们来看看 ELMo、GPT 和 BERT 三者的区别
  ...
  - [![img](assets/BERT-GPT-比较.png)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/BERT-GPT-比较.png)
  ...
  - GPT 使用 Transformer Decoder 作为 Transformer Block，以 P(wi|w1,⋯,wi−1) 为目标函数进行训练，**用 Transformer Block 取代 LSTM 作为特征提取器，实现了单向编码，是一个标准的预训练语言模型，即使用 Fine-Tuning 模式解决下游任务。**

  - BERT 也是一个标准的预训练语言模型，

    它以 P(wi|w1,⋯,wi−1,wi+1,⋯,wn) 为目标函数进行训练，BERT 使用的编码器属于双向编码器
...
[![img](assets/bert-模型结构.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/bert-模型结构.jpg)
...
不同于 GPT 等标准语言模型使用 P(wi|w1,⋯,wi−1) 为目标函数进行训练，能看到全局信息的 BERT 使用 P(wi|w1,⋯,wi−1,wi+1,⋯,wn) 为目标函数进行训练。
...
[![img](assets/BERT-输入.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/BERT-输入.jpg)
...
[![img](assets/segment-embeddings.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/segment-embeddings.jpg)
...
[![img](assets/句对分类.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/句对分类.jpg)
...
[![img](assets/单句分类.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/单句分类.jpg)
...
[![img](assets/文本问答.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/文本问答.jpg)
...
[![img](assets/单句标注.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/单句标注.jpg)
...
[![img](assets/bert-效果.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/bert-效果.jpg)

# 十五、预训练语言模型总结

[![img](assets/总结.jpg)](https://imgmd.oss-cn-shanghai.aliyuncs.com/BERT_IMG/总结.jpg)
...
由于个人刚入门 NLP 方向，就不妄自总结，上述总结全部来自知乎文章：[从Word Embedding到Bert模型—自然语言处理中的预训练技术发展史-](https://zhuanlan.zhihu.com/p/49271699)[张俊林](https://www.zhihu.com/people/zhang-jun-lin-76)
...
>   - [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](https://tooob.com/api/objs/read/noteid/28717995/)
> - 参考博客：
>   - [深度学习中的注意力模型（2017版）](https://zhuanlan.zhihu.com/p/37601161)
>   - [细讲 | Attention Is All You Need](https://mp.weixin.qq.com/s/RLxWevVWHXgX-UcoxDS70w)
>   - [从Word Embedding到Bert模型—自然语言处理中的预训练技术发展史](https://zhuanlan.zhihu.com/p/49271699)
>   - [Attention和Transformer详解](https://www.cnblogs.com/nickchen121/p/15071844.html)
>   - [【NLP】Transformer模型原理详解](https://zhuanlan.zhihu.com/p/44121378)
>   - [LSTM如何解决RNN带来的梯度消失问题](https://zhuanlan.zhihu.com/p/136223550)
