...
- 业务
  ...
  - 点对点短消息业务
    ...
    - ![image-20230322163101973](assets/image-20230322163101973.png)
...
- 层次结构
  ...
  - 概览：![image-20230322152317602](assets/image-20230322152317602.png)
...
- 流程
  ...
  - MO![image-20230322155829781](assets/image-20230322155829781.png)
    - Acknowledgement![image-20230322160019671](assets/image-20230322160019671.png)

  - MT![image-20230322155447956](assets/image-20230322155447956.png)
    - Acknowledgement![image-20230322155733881](assets/image-20230322155733881.png)
...
- ![image-20230323000544236](assets/image-20230323000544236.png)
- GSM 7 bit default alphabet
  - ![image-20230323001146648](assets/image-20230323001146648.png)
...
- GSM  7  bit  default  alphabet  extension  table
  - ![image-20230323001705097](assets/image-20230323001705097.png)
...
- 结构
  1. 7bit编码
     - ![image-20230323095814354](assets/image-20230323095814354.png)
  ...
  2. 8bit/16bit编码
     - ![image-20230323095900815](assets/image-20230323095900815.png)
...
- log流程
  ...
  - ![image-20230210100644648](assets/image-20230210100644648.png)


## VM

- ![image-20230323135931567](assets/image-20230323135931567.png)

- ![image-20230410100224374](assets/image-20230410100224374.png)

- ![image-20230410101005674](assets/image-20230410101005674.png)
...
- ![image-20220805141848052](assets/image-20220805141848052.png)
...
- mifi密码查看
  - 目前WiFi AP 默认是打开的，如果大家要连接AP，可以这样查询密码 如这个密码是4pbtn47yxc5j4f6
    ...
    - ![企业微信截图_17356123437630](assets/企业微信截图_17356123437630.png)
- ifconfig -s eth0 static 172.24.62.189 255.255.255.0 172.24.63.254
- 删除 androidt/out/target/product/B321MH/resign
  - ![image-20250313214410814](assets/image-20250313214410814.png)
...
2. 创建case
   - ![image-20230213160115479](assets/image-20230213160115479.png)
3. 提交附件和添加邮件通知成员
   - ![image-20230213160322318](assets/image-20230213160322318.png)
4. 交流并解决问题。
