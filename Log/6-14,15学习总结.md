...
- 6.14
  ...
  2. 疯狂Android讲义（1页-46页）
     1. Android是什么
     1. Android是干什么的
     1. Android默认使用gradle作为项目管理工具，需掌握Gradle
     1. 学习IDE的使用，Android Studio，Android SDK，以及Android SDK提供的模拟器和调试器
     1. 如何创建Android应用
     1. Android应用的目录结构，初步了解其作用

- 6.15
  1. 进一步了解Android应用的目录结构
...
- ==问题==：view和子类的继承关系是什么样的？
  - ![·](E:\My Documents\Sorting-Logic\Log\6-14,15学习总结.assets\SouthEast.jpeg)
